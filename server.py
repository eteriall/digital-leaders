...
textlist = [
    """<h2><strong>Конспект урока</strong></h2> 

<h3>Что такое CV?</h3>
<p>CV - аббревиатура от латинского 
«курикулюм витай», что в переводе значит «ход жизни». Это и есть сам файл с резюме.</p> 

<h3>Кто такие HR-ы?</h3> 
<p>HR - аббревиатура от «human resources», то есть, человеческих 
ресурсов, HR-ы - это кадровые специалисты. Часто, также, их называют head-hunter-ами, охотниками за головами. Отсюда, 
кстати, и появилось название известной платформы HH.ru.</p>
""",
    """<h2><strong>Конспект урока</strong></h2>
